    ...
    <>
      <div className='mx-3 pt-10'>
        ...
        <div className='mt-12 grid place-items-center'>
          <a className='text-lg font-mono text-red-400' href="https://shubham-buggie.netlify.app/" target="_blank" rel="noopener noreferrer">😎 <span className='hover:underline hover:text-green-500'>Developer Details</span> 😎</a>
        </div>
      </div>
    </>
  )
