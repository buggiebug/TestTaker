...
function UpdateQuestion() {
  ...
  return (
    <>
        <div className='w-full grid place-items-center mt-32'>
          <div className='flex justify-start w-full ml-10'>
            <button onClick={()=>{navigateToBack()}} className='text-white hover:underline'><i className="fa-solid fa-backward mr-2"></i> Back</button>
          </div>
          <div className='bg-white shadow-lg rounded-md my-10 p-5 w-[90vw] md:w-[50vw]'>
