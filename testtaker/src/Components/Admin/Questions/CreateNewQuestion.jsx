...
function CreateNewQuestion() {
  ...
  return (
    <>
      <div className='bg-white md:w-[50vw] w-[90vw] flex flex-col justify-center items-center shadow-lg rounded-md my-10 p-5'>
          <h3 className='text-2xl text-center font-mono'>Create new question !</h3>
          <div>
